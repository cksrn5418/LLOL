 ...
 * [FreeFragment.OnFragmentInteractionListener] interface
...
class FreeFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        free_btn.setOnClickListener {
            ...
            transaction.replace(R.id.fragment, FreeWriteFragment())
            transaction.addToBackStack(null)
            transaction.commit()
        }
        free_listview.adapter = FreeDataAdapter(context!!, R.layout.free_row, GlobalApplication.free_list)
        free_listview.setOnItemClickListener { parent, view, position, id ->
            GlobalApplication.free_index = position
            var transaction = fragmentManager!!.beginTransaction()
            transaction.replace(R.id.fragment, FreeReadFragment())
            transaction.addToBackStack(null)
            transaction.commit()
        }
    }
