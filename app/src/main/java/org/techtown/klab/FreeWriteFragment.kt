 ...
 * [FreeWriteFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FreeWriteFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class FreeWriteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_free_write, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        free_savebtn.setOnClickListener {
        ...
        free_cancelbtn.setOnClickListener {
            transaction.replace(R.id.fragment, FreeFragment())
            transaction.addToBackStack(null)
            transaction.commit()
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment FreeWriteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FreeWriteFragment().apply {
